...
window.DATA_SOURCES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Steam Games Dataset (Kaggle, FronkonGames)", url: "https://www.kaggle.com/datasets/fronkongames/steam-games-dataset", desc: "เกมบน Steam หลายหมื่นเกม: ราคา แท็ก รีวิว ยอดผู้เล่นโดยประมาณ วันวางขาย", tags: ["เกม", "CSV"] },
      { name: "Steam Store Games (Kaggle, Nik Davis)", url: "https://www.kaggle.com/datasets/nikdavis/steam-store-games", desc: "ชุดข้อมูลเกม Steam ~27,000 เกมที่ทำความสะอาดแล้ว เหมาะกับมือใหม่", tags: ["เกม", "CSV", "มือใหม่"] },
      { name: "Video Game Sales (Kaggle, VGChartz)", url: "https://www.kaggle.com/datasets/gregorut/videogamesales", desc: "ยอดขายเกมคอนโซล/PC แยกภูมิภาค NA/EU/JP ย้อนหลังหลายสิบปี", tags: ["เกม", "ยอดขาย"] },
      { name: "SteamDB", url: "https://steamdb.info", desc: "ดูสถิติผู้เล่นพร้อมกัน ราคา ประวัติส่วนลดของแต่ละเกม (ใช้อ้างอิง/ตรวจสอบ ไม่มี API ให้ดาวน์โหลด)", tags: ["เกม", "อ้างอิง"] },
...
window.PROJECT_IDEAS = [
  ...
  { title: "Steam Game Market Analysis", data: "ชุดเดโม่ ตลาดเกม / SteamSpy / Kaggle Steam datasets", q: "แนวเกมไหนน่าลงทุน? ราคาเท่าไรเหมาะ? ปัจจัยอะไรทำให้เกมฮิต?", tools: ["Python", "Power BI", "SQL"] },
